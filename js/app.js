(() => {
    ...
    (() => {
        ...
        if (document.querySelector(".result__slider")) new core(".result__slider", {
                    ...
                    entries.forEach((function(video) {
                        if (video.isIntersecting) {
                            for (var source in video.target.children) {
                                ...
                                if ("string" === typeof videoSource.tagName && "SOURCE" === videoSource.tagName) videoSource.src = videoSource.dataset.src;
                            }
                            video.target.load();
